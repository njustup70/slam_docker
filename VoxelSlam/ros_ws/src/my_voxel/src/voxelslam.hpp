...
bool sync_packages(pcl::PointCloud<PointType>::Ptr &pl_ptr, deque<sensor_msgs::Imu::Ptr> &imus, IMUEKF &p_imu, ros::Time &pcl_time)
{
  ...
  if(!pl_ready)
  {
    ...
    pcl_time = ros::Time(p_imu.pcl_end_time);
